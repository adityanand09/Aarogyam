...
import com.aarogyam.Model.AccessToken;
import com.aarogyam.Model.HealthDiagnosis;
import com.aarogyam.Model.HealthIssueInfo;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static int progresVisibility = View.GONE;
        ...
        btn.setOnClickListener(view -> {
            ...
            if(App.accessToken == null) {
                ...
                if(activeNetwork != null && activeNetwork.isConnected()) {
                    ...
                    new LoadToken().execute(getString(R.string.priaid_authservice_url), getString(R.string.usrname), getString(R.string.password));
                }else{
                    btn.setEnabled(true);
    ...
    public void load(String action, TypeReference<?> valueTypeRef){
        ...
        if(activeNetwork != null && activeNetwork.isConnected()) {
            progresVisibility = View.VISIBLE;
            progressBar.setVisibility(View.VISIBLE);
            new loadService().execute(new Pair(url, valueTypeRef));
        }else{
            new CustomToast(MainActivity.this, "App not connected to internet").show();
        }
    }
    ...
    class LoadToken extends AsyncTask<String, Void, AccessToken> {
    ...
    class loadService extends AsyncTask<Pair, Void, Object> {
        ...
        protected Object doInBackground(Pair... pairs) {
            ...
            try {
                ...
                new CustomToast(MainActivity.this, "Something went Wrong").show();
            }
            return null;
        }
